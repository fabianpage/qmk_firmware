./util/docker_build.sh moonlander:fabian

./util/docker_build.sh moonlander:fabian && sudo wally-cli ./moonlander_fabian.bin

nix-shell --pure --arg avr false --run "make massdrop/alt:default"

qmk compile -kb moonlander -km fabian
